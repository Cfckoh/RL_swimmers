...
class ABCflow():
    ...
    def __init__(self,sep_size=0.2*np.pi, a=1.,b=.7,c=.43,seed=1,kappa=(0.02*np.pi)**2 * 0.2519):
        super().__init__()
    ...
    def getState(self):
        return np.array(self.passive-self.active)
