"""New implementation of actor pysicists for synthetic environment. Actions are restricted to just phi values (1d action).
"""
...
class RL_phi_agent:
    def __init__(self, state_size=2, output_size=2, hidden_size=32, num_layers=3, actor_lr=0.00001, discount=.99, action_scale=5.):
...
if __name__=="__main__":
    ...
    for i in range(1,2):
        ...
        # history data structs across episodes
        num_ep= 400
        ...
        agent.save_policy(f"saved_models/julia_num_env_{baseline_phi}_{t_end}.pt")
